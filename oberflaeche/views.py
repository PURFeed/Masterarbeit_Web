...
# Methode to fill the Database with Entries
def import_data(request):
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_e.get_mitigations_mitigating_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_e.get_software_using_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_e.get_groups_using_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for soft in software1:
        temp = mitre_attack_data_e.get_groups_using_software(soft.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_e.get_tactics_by_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_e.get_campaigns_using_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for software in software1:
        temp = mitre_attack_data_e.get_campaigns_using_software(software.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for group in groups1:
        temp = mitre_attack_data_e.get_campaigns_attributed_to_group(group.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_m.get_mitigations_mitigating_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_m.get_software_using_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_m.get_groups_using_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for soft in software1:
        temp = mitre_attack_data_m.get_groups_using_software(soft.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_m.get_tactics_by_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_m.get_campaigns_using_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for software in software1:
        temp = mitre_attack_data_m.get_campaigns_using_software(software.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for group in groups1:
        temp = mitre_attack_data_m.get_campaigns_attributed_to_group(group.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_i.get_mitigations_mitigating_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_i.get_software_using_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_i.get_groups_using_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for soft in software1:
        temp = mitre_attack_data_i.get_groups_using_software(soft.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_i.get_tactics_by_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for techniques in techniques1:
        temp = mitre_attack_data_i.get_campaigns_using_technique(techniques.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for software in software1:
        temp = mitre_attack_data_i.get_campaigns_using_software(software.id)
        for l in temp:
            if not l:
                continue
            else:
    ...
    for group in groups1:
        temp = mitre_attack_data_i.get_campaigns_attributed_to_group(group.id)
        for l in temp:
            if not l:
                continue
            else:
